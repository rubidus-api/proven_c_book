...
#prereq(
  ...
  ([chapter 58, The terrain of the standard library], [the contract the standard settles]),
)
...
#demo("examples-en/ch71/timefns.c")
...
#antipattern[
  ...
  (those functions chapter 58 brushed past by name only). The next call overwrites
