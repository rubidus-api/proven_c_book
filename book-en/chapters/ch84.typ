...
#platform[
  ...
  - *Measuring stack usage* — the stack painting seen in chapter 71, and static
...
#demo("examples-en/ch84/ccompat.c")
...
#qa[
  ...
  statistics, a simple configuration-file parser (chapter 79's scanner is used as it
