...
#dtable(
  ...
  [string literal], [`"hello"`], [an array, not a constant (chapter 41)],
...
The *translation phases* covered in chapter 56 are the front half of this
...
#misconception[
  ...
  only (chapter 53) — becomes natural, and you understand why the language rule
...
#qa[
  ...
  changed. That world opens in chapter 53.
]
