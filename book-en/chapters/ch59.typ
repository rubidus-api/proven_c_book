...
#dtable(
  ...
  [`gets_s`], [C11 annex K (optional)], [implementations barely exist — treated in chapter 67],
)
...
variable that failed (we see it in the flesh in chapter 73).
...
#misconception[
  ...
  wrong file." We run this pattern for real in chapter 73.
]
