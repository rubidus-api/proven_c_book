...
#prereq(
  ([chapter 58, Functions as values], [the notation of a function pointer]),
  ([chapter 38, Arrays], [the array declarator]),
)

#deepqa[
  While learning function pointers in chapter 58 a declaration like
...
#misconception[
  ...
  error (thanks to chapter 45's property that a struct is a value). A device like
...
#demo("examples-en/ch59/monster.c")
