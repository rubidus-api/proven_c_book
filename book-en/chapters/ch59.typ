...
#dtable(
  ...
  [`gets_s`], [C11 annex K (optional)], [implementations barely exist — treated in chapter 66],
)
...
variable that failed (we see it in the flesh in chapter 72).
...
#misconception[
  ...
  wrong file." We run this pattern for real in chapter 72.
]
