...
#demo("examples-en/ch62/streams.c")
...
`perror` prints it as a sentence a human can read (chapter 74). The file may not
...
#demo("examples-en/ch62/feof_bad.c")
...
#qa[
  ...
  enlarge the buffer when needed (chapter 44's dynamic allocation). Third, *a
