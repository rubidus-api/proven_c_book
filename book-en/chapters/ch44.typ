...
#realcase[
  ...
  `struct sigaction`, chapter 65, or `struct timespec`), and the `..._desc`
...
standard word of C23 (chapter 71).
...
smaller in recursion or on a per-thread stack (chapter 68). Recursion passing
