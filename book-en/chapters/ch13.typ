...
contract (revisited with the safe methods in chapter 46).
...
the next part (chapter 46 does this demonstration properly). The point is not the
...
standard's name for this state is *undefined behaviour* (UB), and chapter 50 of
...
#qa[
  ...
  code outside the contract is faced head on in chapter 50 (undefined behaviour).
]
