...
contract (revisited with the safe methods in chapter 45).
...
the next part (chapter 45 does this demonstration properly). The point is not the
...
standard's name for this state is *undefined behaviour* (UB), and chapter 47 of
...
#qa[
  ...
  code outside the contract is faced head on in chapter 47 (undefined behaviour).
]
