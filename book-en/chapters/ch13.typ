...
contract (revisited with the safe methods in chapter 47).
...
the next part (chapter 47 does this demonstration properly). The point is not the
...
standard's name for this state is *undefined behaviour* (UB), and chapter 51 of
...
#qa[
  ...
  code outside the contract is faced head on in chapter 51 (undefined behaviour).
]
