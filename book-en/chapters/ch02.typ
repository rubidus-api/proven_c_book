...
#realcase[
  ...
  here). The detailed numbers and remedies are treated in chapters 41 and 70.
]
...
#dtable(
  ...
  [chapter 70], [the real map in operating systems and embedded work],
  [chapter 71], [inside the allocator that manages the warehouse],
)
