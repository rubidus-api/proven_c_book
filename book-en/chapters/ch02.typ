...
#qa[
  ...
  most often, and chapter 40 treats it formally.
]
...
#realcase[
  ...
  here). The detailed numbers and remedies are treated in chapters 40 and 69.
]
...
#misconception[
  ...
  slow even with small amounts (we measure it in chapter 41). And for a reason we
...
#dtable(
  ...
  [chapter 40], [lifetime and storage duration — what C's grammar calls these regions],
  [chapter 41], [dynamic memory — the discipline of borrowing from and returning to the warehouse],
  [chapter 69], [the real map in operating systems and embedded work],
  [chapter 70], [inside the allocator that manages the warehouse],
)
