...
#qa[
  ...
  chapter 10 will show — doing several things in one step is the real weapon of
  a modern CPU.
]
...
#misconception[
  ...
  of bits can later be read as a number or as a character (chapters 6 and 7).
]
...
(that is the story of chapters 9 and 10). But for a computer of the early
...
the slot is only bits, and interpretation decides" — the lesson of chapter 3 —
...
addressed memory in *bytes* rather than words (chapter 3's corridor is exactly
...
byte-oriented to the bone (the byte of chapter 2, the corridor of chapter 3),
