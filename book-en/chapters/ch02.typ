...
#realcase[
  ...
  here). The detailed numbers and remedies are treated in chapters 41 and 72.
]
...
#dtable(
  ...
  [chapter 72], [the real map in operating systems and embedded work],
  [chapter 73], [inside the allocator that manages the warehouse],
)
