...
#qa[
  ...
  most often, and chapter 41 treats it formally.
]
...
#realcase[
  ...
  here). The detailed numbers and remedies are treated in chapters 41 and 71.
]
...
#misconception[
  ...
  slow even with small amounts (we measure it in chapter 42). And for a reason we
...
#dtable(
  ...
  [chapter 71], [the real map in operating systems and embedded work],
  [chapter 72], [inside the allocator that manages the warehouse],
)
