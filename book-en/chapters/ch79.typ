...
world of the *freestanding implementation* seen in chapter 58. Here most of the
...
in chapter 56 — where the address spaces of code and data are entirely different —
becomes flesh here.
...
function pointers about (chapter 56) leaves the compiler unable to know the graph
