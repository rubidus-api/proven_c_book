...
#prereq(
  ...
  ([chapter 66, Locales ①], [`LC_CTYPE`]),
  ([chapter 65, Character classification], [the limit of per-byte judgement]),
)
...
#demo("examples-en/ch68/wide_lit.c")
...
Chapter 66's demonstration showed `MB_CUR_MAX` changing with the locale: 1 (C),
...
#demo("examples-en/ch68/mbrtowc_step.c")
