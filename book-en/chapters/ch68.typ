...
#deepqa[
  Chapter 67 said a locale is data holding conventions. What exactly is that data
...
#qa[
  ...
  *There is none in standard C.* `localeconv` hands over the materials; the
  ...
  (chapter 49). Keep it as an integer number of the smallest unit and insert the
...
#realcase[
  ...
  `"C"` with chapter 67's idiom, and format separately when showing a person.
]
...
#demo("examples-en/ch68/time_locale.c")
...
#demo("examples-en/ch68/collate.c")
