...
#demo("examples-en/ch54/parens.c")
...
The `__VA_OPT__` C23 brought in (chapter 78) puts something in "only when the variadic
...
#demo("examples-en/ch54/xmacro.c")
