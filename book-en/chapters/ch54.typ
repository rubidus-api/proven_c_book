...
#prereq(
  ([chapter 53, Functions as values], [the notation of a function pointer]),
  ([chapter 37, Arrays], [the array declarator]),
)

#deepqa[
  While learning function pointers in chapter 53 a declaration like
...
#misconception[
  ...
  error (thanks to chapter 42's property that a struct is a value). A device like
