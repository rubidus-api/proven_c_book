...
#demo("examples-en/ch61/streams.c")
...
`perror` prints it as a sentence a human can read (chapter 73). The file may not
...
#demo("examples-en/ch61/feof_bad.c")
...
#qa[
  ...
  enlarge the buffer when needed (chapter 43's dynamic allocation). Third, *a
