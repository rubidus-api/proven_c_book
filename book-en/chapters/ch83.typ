...
#platform[
  ...
  - *Measuring stack usage* — the stack painting seen in chapter 70, and static
...
#demo("examples-en/ch83/ccompat.c")
...
#qa[
  ...
  statistics, a simple configuration-file parser (chapter 78's scanner is used as it
