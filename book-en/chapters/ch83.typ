...
#prereq(
  ...
  ([chapter 81, C in practice], [the tools of practice]),
)
...
#organizer[
  The last chapter. Chapter 81 looked round the terrain of practice, so now we gather
...
#qa[
  ...
  directly the source of the projects named in chapter 81. Well-written C code like
