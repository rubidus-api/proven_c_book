...
#prereq(
  ...
  ([chapter 52, Many files — splitting and linking], [linkage — does a name cross the file boundary]),
)

#deepqa[
  Chapter 52 said a name has, besides scope, a second property called
...
#qa[
  ...
  preprocessor knows nothing of C's grammar (chapter 55). So a macro name ignores
...
#dtable(
  ...
  [Linkage (ch. 52)], [whether it is *the same thing* as that spelling in another translation unit], [external / internal / none], [`static`, `extern`, and where it is declared],
...
#qa[
  ...
  chapter 52's discipline about headers matters.
]
...
The ground is §7.1.3, and the fuller story returns in chapter 79.
