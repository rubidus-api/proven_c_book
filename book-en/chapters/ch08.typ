...
#misconception[
  ...
  (chapter 47). One thing to remember for now: *floating point is not an exact
...
This table is the origin of the properties met in chapter 47. That NaN is not
equal to itself, that infinity comes out of overflow, that `+0.0 == -0.0` while
their bits differ — all of it comes from this layout. Chapter 47 confirms each of
...
covered in C code in chapter 47. What to remember now is one sentence: *code
...
#qa[
  ...
  *range*, so it overflows at the end (and is perfectly exact until it does);
  ...
  fundamental of handling numbers, and choosing types in C (chapters 26 and 47)
