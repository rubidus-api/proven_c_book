...
mean to look at `errno`, set it to 0 just before the call (chapter 65).
...
#qa[
  ...
  and check immediately after (chapter 65). To inspect the value itself use
