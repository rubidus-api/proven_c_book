...
#dtable(
  ...
  [`<inttypes.h>`], [C99], [formats and conversions for fixed-width integers], [appendix B, chapter 67],
  [`<iso646.h>`], [C95], [alternative spellings of operators], [chapter 67],
  ...
  [`<stdalign.h>`], [C11], [specifying and querying alignment], [chapter 67],
  [`<stdarg.h>`], [C89], [variadic arguments], [chapter 53],
  [`<stdatomic.h>`], [C11], [atomic operations], [chapter 68],
  [`<stdbit.h>`], [C23], [bit manipulation (counting, rotating and so on)], [chapter 67],
  [`<stdbool.h>`], [C99], [`bool`, `true`, `false`], [chapter 67],
  [`<stdckdint.h>`], [C23], [arithmetic that checks for overflow], [chapters 49, 69],
  [`<stddef.h>`], [C89], [`size_t`, `ptrdiff_t`, `NULL`, `offsetof`], [chapter 67],
  [`<stdint.h>`], [C99], [fixed-width integer types], [chapters 26, 67],
