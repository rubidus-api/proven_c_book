...
#dtable(
  ...
  [`<assert.h>`], [C89], [`assert` — the diagnosis that catches contract violations], [chapter 70],
  [`<complex.h>`], [C99], [complex arithmetic], [chapter 68],
  [`<ctype.h>`], [C89], [character classification and conversion], [chapter 62],
  [`<errno.h>`], [C89], [the error-number global], [chapter 70],
  [`<fenv.h>`], [C99], [the floating-point environment (rounding, exceptions)], [chapter 68],
  [`<float.h>`], [C89], [the limits of real types], [chapters 26, 68],
  [`<inttypes.h>`], [C99], [formats and conversions for fixed-width integers], [appendix B, chapter 73],
  [`<iso646.h>`], [C95], [alternative spellings of operators], [chapter 73],
  [`<limits.h>`], [C89], [the limits of integer types], [chapter 26],
  [`<locale.h>`], [C89], [locale settings], [chapter 62],
  [`<math.h>`], [C89], [mathematical functions], [chapter 68],
  [`<setjmp.h>`], [C89], [non-local jumps], [chapter 70],
  [`<signal.h>`], [C89], [signal handling], [chapter 70],
  [`<stdalign.h>`], [C11], [specifying and querying alignment], [chapter 73],
  [`<stdarg.h>`], [C89], [variadic arguments], [chapter 53],
  [`<stdatomic.h>`], [C11], [atomic operations], [chapter 74],
  [`<stdbit.h>`], [C23], [bit manipulation (counting, rotating and so on)], [chapter 73],
  [`<stdbool.h>`], [C99], [`bool`, `true`, `false`], [chapter 73],
  [`<stdckdint.h>`], [C23], [arithmetic that checks for overflow], [chapters 49, 75],
  [`<stddef.h>`], [C89], [`size_t`, `ptrdiff_t`, `NULL`, `offsetof`], [chapter 73],
  [`<stdint.h>`], [C99], [fixed-width integer types], [chapters 26, 73],
  ...
  [`<stdnoreturn.h>`], [C11], [`noreturn`], [chapter 73],
  [`<string.h>`], [C89], [strings and memory blocks], [chapter 60],
  [`<tgmath.h>`], [C99], [type-generic mathematical functions], [chapter 68],
  [`<threads.h>`], [C11], [threads, mutexes, condition variables], [chapter 73],
  [`<time.h>`], [C89], [time and the calendar], [chapter 69],
