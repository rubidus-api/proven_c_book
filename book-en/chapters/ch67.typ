...
#prereq(
  ...
  ([chapter 65, Locales ①], [`LC_CTYPE`]),
  ([chapter 64, Character classification], [the limit of per-byte judgement]),
)
...
#demo("examples-en/ch67/wide_lit.c")
...
Chapter 65's demonstration showed `MB_CUR_MAX` changing with the locale: 1 (C),
...
#demo("examples-en/ch67/mbrtowc_step.c")
