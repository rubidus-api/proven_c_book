...
#prereq(
  ...
  ([chapter 43, Lifetime and storage duration], [lifetime and sharing]),
)
...
#demo("examples-en/ch78/atomic.c")
...
#misconception[
  ...
  behaviour (chapter 51). It means there is no guarantee that it ends at the level
...
these accesses*. As will be seen in chapter 51, its purpose was hardware registers
...
#dtable(
  ...
  [sharing with a signal handler], [`sig_atomic_t` or a lock-free atomic type], [chapter 74's restrictions],
