...
argument too.* What `fgetc` returns must be passable straight in (chapter 62), and
...
the first trap. Chapter 62's rule, "always receive what `fgetc` returns in an
`int`", comes back here.
