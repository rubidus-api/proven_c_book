...
#prereq(
  ([chapter 54, Functions as values], [the notation of a function pointer]),
  ([chapter 37, Arrays], [the array declarator]),
)

#deepqa[
  While learning function pointers in chapter 54 a declaration like
