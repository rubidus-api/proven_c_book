...
#prereq(
  ...
  ([chapter 83, C in practice], [the tools of practice]),
)
...
#organizer[
  The last chapter. Chapter 83 looked round the terrain of practice, so now we gather
...
#qa[
  ...
  directly the source of the projects named in chapter 83. Well-written C code like
