...
#platform[
  ...
  - *Measuring stack usage* — the stack painting seen in chapter 72, and static
...
#demo("examples-en/ch85/ccompat.c")
...
#qa[
  ...
  statistics, a simple configuration-file parser (chapter 80's scanner is used as it
