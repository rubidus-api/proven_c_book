...
#dtable(
  ...
  [`<fenv.h>`], [the floating-point environment], [chapter 68],
  [`<tgmath.h>`], [type-generic mathematics], [chapter 68],
)
...
#qa[
  ...
  *API designs that carry the length along*. The last is the direction this book
  has pushed, and chapters 82 and 84 are its implementation.
  ...
  chapter 79 arranges the five bugs.
]
...
#demo("examples-en/ch73/newheaders.c")
