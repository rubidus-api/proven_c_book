...
#prereq(
  ([chapter 45, Structs], [values bundled in a struct]),
  ([chapter 60, The terrain of the standard library], [the contract the standard settles]),
)
...
#demo("examples-en/ch73/timefns.c")
...
#antipattern[
  ...
  (those functions chapter 60 brushed past by name only). The next call overwrites
