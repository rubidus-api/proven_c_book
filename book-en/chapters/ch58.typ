...
#prereq(
  ([chapter 57, Functions as values], [the notation of a function pointer]),
  ([chapter 38, Arrays], [the array declarator]),
)

#deepqa[
  While learning function pointers in chapter 57 a declaration like
...
#misconception[
  ...
  error (thanks to chapter 44's property that a struct is a value). A device like
...
#demo("examples-en/ch58/monster.c")
