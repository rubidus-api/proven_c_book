...
#deepqa[
  ...
  every time, and chapter 57 said functions that do not take a size are the first
...
#demo("examples-en/ch60/strncpy.c")
...
But as seen in chapter 57, the compiler catches *only what it can see*. If the
...
#demo("examples-en/ch60/overlap.c")
