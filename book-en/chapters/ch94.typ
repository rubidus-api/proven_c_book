...
#prereq(
  ...
  ([chapter 92, C in practice], [the tools of practice]),
)
...
#organizer[
  The last chapter. Chapter 92 looked round the terrain of practice, so now we gather
...
#dtable(
  ...
  [the relaxation of `va_start`], [chapter 55], [removing the excess of variadic arguments],
)
...
lay components with checking built in over the repeated danger zones (chapter 58 and
Part XII).
...
#qa[
  ...
  directly the source of the projects named in chapter 92. Well-written C code like
