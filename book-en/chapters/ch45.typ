...
#demo("examples-en/ch45/sizeof_first.c")
...
#qa[
  ...
  alignment (`alignas`) are in chapter 46. What to know first is that *they are
...
#demo("examples-en/ch45/zeroinit.c")
...
#qa[
  ...
  *a pointer to itself*, and that is precisely the seed of linked data structures:
  ...
  chapter 44's dynamic memory meet in that one line and structures such as linked
...
#misconception[
  ...
  *representations* — it looks at the padding as well as the members.
  ...
  Chapter 46's demonstration shows this in the flesh: two structs whose members
...
#demo("examples-en/ch45/flexible.c")
...
needed. And the length arithmetic *must be checked for overflow* (chapter 74) — a
