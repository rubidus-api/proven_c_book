...
#prereq(
  ...
  ([chapter 67, Locales ①], [`LC_CTYPE`]),
  ([chapter 66, Character classification], [the limit of per-byte judgement]),
)
...
#demo("examples-en/ch69/wide_lit.c")
...
Chapter 67's demonstration showed `MB_CUR_MAX` changing with the locale: 1 (C),
...
#demo("examples-en/ch69/mbrtowc_step.c")
