...
#demo("examples-en/ch72/truncate.c")
...
#demo("examples-en/ch72/unchecked.c")
...
#demo("examples-en/ch72/cmp_bad.c")
...
#realcase[
  ...
  *worst case* is itself a security problem, and so today's libraries take as their
  ...
  using a random seed — we see them in the flesh in chapter 79.
]
