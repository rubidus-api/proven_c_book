...
#demo("examples-en/ch72/errno_demo.c")
...
#dtable(
  ...
  [`strerror_s`], [the same intent], [annex K (chapter 75)],
)
...
in servers, shells and terminals, all in chapter 73.
...
software such as libjpeg and Lua, and today's alternatives, all in chapter 74.
