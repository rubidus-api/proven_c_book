...
#misconception[
  ...
  (chapter 40). One thing to remember for now: *floating point is not an exact
...
covered in C code in chapter 40. What to remember now is one sentence: *code
...
and we meet this "age of contracts" again in chapter 10.
...
#qa[
  Integer overflow in chapter 5 and rounding in this chapter are both problems
  ...
  *range*, so it overflows at the end (and is perfectly exact until it does);
  ...
  fundamental of handling numbers, and choosing types in C (chapters 23 and 40)
