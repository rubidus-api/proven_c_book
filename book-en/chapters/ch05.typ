...
ordinary idea later becomes C's most famous concept, the *pointer* (chapter 35).
...
properly in chapters 35 and 37. What to take away now is one line — *an address
...
choice again (chapter 35 shows the cases). Moreover, *some instruction sets use
...
#qa[
  ...
  chapter 47 (unions) — that is where we get the tool for reading the same
...
spaces (the Harvard architecture — the small chips of chapter 95 still do).
...
once pointers arrive in chapter 35 and provenance in chapter 37.
...
#qa[
  ...
  address into an integer and make what I like of it" (chapter 37).
]
