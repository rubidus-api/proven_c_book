...
#prereq(
  ...
  ([chapter 51, Many files — splitting and linking], [linkage — does a name cross the file boundary]),
)

#deepqa[
  Chapter 51 said a name has, besides scope, a second property called
...
#demo("examples/ch52/four_spaces.c")
...
#qa[
  ...
  preprocessor knows nothing of C's grammar (chapter 54). So a macro name ignores
...
#dtable(
  ...
  [Linkage (ch. 51)], [whether it is *the same thing* as that spelling in another translation unit], [external / internal / none], [`static`, `extern`, and where it is declared],
...
#qa[
  ...
  chapter 51's discipline about headers matters.
]
...
#demo("examples/ch52/tag_typedef.c")
...
The ground is §7.1.3, and the fuller story returns in chapter 78.
