...
#prereq(
  ...
  ([chapter 42, Lifetime and storage duration], [lifetime and sharing]),
)
...
#demo("examples-en/ch77/atomic.c")
...
#misconception[
  ...
  behaviour (chapter 50). It means there is no guarantee that it ends at the level
...
these accesses*. As will be seen in chapter 50, its purpose was hardware registers
...
#dtable(
  ...
  [sharing with a signal handler], [`sig_atomic_t` or a lock-free atomic type], [chapter 73's restrictions],
