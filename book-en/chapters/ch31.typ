...
#prereq(
  ([chapter 30, Booleans and comparison], [the result of a comparison is true or false]),
)
...
In the condition's place goes an expression that becomes a bool (chapter 30),
...
#demo("examples-en/ch31/grade.c", stdin: true)
...
#demo("examples-en/ch31/season.c", stdin: true)
