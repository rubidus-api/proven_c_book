...
two languages" seen in chapter 84.
...
#qa[
  ...
  *the standard is an institution that must protect existing code*, so when "the right
  ...
  (chapter 84's "siblings, not parent and child" is confirmed here too).
...
seen in chapter 67 and appendix B stand exactly on this rule.
