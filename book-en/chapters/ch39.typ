...
not as a type*, and breaking it is chapter 49's undefined behaviour — mostly it dies on
...
two languages" seen in chapter 83.
...
#qa[
  ...
  *the standard is an institution that must protect existing code*, so when "the right
  ...
  (chapter 83's "siblings, not parent and child" is confirmed here too).
...
#demo("examples-en/ch39/literal.c")
...
seen in chapter 66 and appendix B stand exactly on this rule.
