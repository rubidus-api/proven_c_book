...
/* The subscript macro: every argument wrapped in parentheses (chapter 54), and the
...
/* The size computation can overflow — if it does, no allocation is attempted (ch. 49, 77). */
