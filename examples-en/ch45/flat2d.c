...
/* The subscript macro: every argument wrapped in parentheses (chapter 57), and the
...
/* The size computation can overflow — if it does, no allocation is attempted (ch. 52, 80). */
