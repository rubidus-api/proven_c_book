...
- **Current edition**: v0.48.1 — **draft**
- **Download the PDF** — [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.48.1/proven_c_book-v0.48.1-en.pdf) · [Korean PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.48.1/proven_c_book-v0.48.1-ko.pdf)
- **Read on the web** — [English](https://rubidus-api.github.io/proven_c_book/en/) · [한국어](https://rubidus-api.github.io/proven_c_book/ko/)
- **Bundles (zip)** — [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.48.1/proven_c_book-v0.48.1-en.zip) · [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.48.1/proven_c_book-v0.48.1-ko.zip) · [all](https://github.com/rubidus-api/proven_c_book/releases/download/v0.48.1/proven_c_book-v0.48.1-all.zip)
- Copies inside the repository: [en PDF](dist/proven_c_book-v0.48.1-en.pdf) · [ko PDF](dist/proven_c_book-v0.48.1-ko.pdf)
