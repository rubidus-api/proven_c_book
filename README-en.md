...
- **Current edition**: v0.52.3 — **draft**
- **Download the PDF** — [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.52.3/proven_c_book-v0.52.3-en.pdf) · [Korean PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.52.3/proven_c_book-v0.52.3-ko.pdf)
