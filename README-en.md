...
- A finer grain — [the section map](docs/SECTIONS.md): forward references, difficulty, kind and size for all 490 sections
- To regenerate — `python3 scripts/make-depgraph.py`, `python3 scripts/section-map.py`
