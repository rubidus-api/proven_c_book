...
- **Current edition**: v0.44.0 — **draft**
- **Download the PDF** — [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.44.0/proven_c_book-v0.44.0-en.pdf) · [Korean PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.44.0/proven_c_book-v0.44.0-ko.pdf)
- **Read on the web** — [English](https://rubidus-api.github.io/proven_c_book/en/) · [한국어](https://rubidus-api.github.io/proven_c_book/ko/)
- **Bundles (zip)** — [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.44.0/proven_c_book-v0.44.0-en.zip) · [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.44.0/proven_c_book-v0.44.0-ko.zip) · [all](https://github.com/rubidus-api/proven_c_book/releases/download/v0.44.0/proven_c_book-v0.44.0-all.zip)
- Copies inside the repository: [en PDF](dist/proven_c_book-v0.44.0-en.pdf) · [ko PDF](dist/proven_c_book-v0.44.0-ko.pdf)
