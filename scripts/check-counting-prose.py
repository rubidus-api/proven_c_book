...
#   파일들에서만 본다.
# ★ 목록이 좁으면 낡은 서술을 놓친다 --- RFC-0041 의 검토에서 1장의 「아흔여섯 장」과
#   88장의 「서른여덟 장」이 이 목록 밖이라 몇 판을 그대로 지나갔다. 그래서 열 단위
#   이상의 고유어 수사를 전부 넣는다.
KO_NUM = ("두|세|네|다섯|여섯|일곱|여덟|아홉|열|열한|열두|열세|열네|열다섯|"
          "열여섯|열일곱|열여덟|열아홉|"
          "스무|스물한|스물두|스물세|스물네|스물다섯|스물여섯|스물일곱|스물여덟|스물아홉|스물|"
          "서른한|서른두|서른세|서른네|서른다섯|서른여섯|서른일곱|서른여덟|서른아홉|서른|"
          "마흔한|마흔두|마흔세|마흔네|마흔다섯|마흔여섯|마흔일곱|마흔여덟|마흔아홉|마흔|"
          "쉰한|쉰두|쉰세|쉰네|쉰다섯|쉰여섯|쉰일곱|쉰여덟|쉰아홉|쉰|"
          "예순|일흔|여든세|여든네|여든|아흔여섯|아흔|"
          "여러|몇")
KO_UNIT = "장|절|부"
