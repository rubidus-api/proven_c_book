...
| Ch. | Title | Leans on | Leaned on by |
|---|---|---|---|
| 85 | The five bugs shipped for fifty years | 51, 42, 61 | 86, 87 |
| 86 | What proven is — and getting started | 54, 85 | — |
...
| 94 | The boundaries — running things overlapped, and when there is no OS | 80, 83 | — |
| 95 | Writing it three times — a tiny JSON | 87, 88, 89, 90 | — |

### Part XIII — Closing

| Ch. | Title | Leans on | Leaned on by |
|---|---|---|---|
| 96 | C in practice — tools, projects, and territories | 54, 17 | 98 |
| 97 | The embedded toolbox — compilers and the tools beside them | 18, 83 | — |
| 98 | Modern C, gathered up | 52, 51, 96 | — |
