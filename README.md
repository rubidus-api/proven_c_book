...
- **현재 판**: v0.23.0 — **초안(draft)**
- **PDF 바로 받기** — [한국어 PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.23.0/proven_c_book-v0.23.0-ko.pdf) · [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.23.0/proven_c_book-v0.23.0-en.pdf)
- **웹으로 읽기** — [한국어](https://rubidus-api.github.io/proven_c_book/ko/) · [English](https://rubidus-api.github.io/proven_c_book/en/)
- **묶음(zip)** — [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.23.0/proven_c_book-v0.23.0-ko.zip) · [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.23.0/proven_c_book-v0.23.0-en.zip) · [전체](https://github.com/rubidus-api/proven_c_book/releases/download/v0.23.0/proven_c_book-v0.23.0-all.zip)
- 저장소 안 사본: [ko PDF](dist/proven_c_book-v0.23.0-ko.pdf) · [en PDF](dist/proven_c_book-v0.23.0-en.pdf)
- 13부 94장 + 부록 A~E + 찾아보기 — 한국어판 660쪽, 영어판 695쪽
...
- **인쇄된 실행 결과는 전부 실제 출력이다.** 예제 142개를 매 빌드마다
...
examples/    본문에 실리는 예제 142개 — 전부 검증된 것
