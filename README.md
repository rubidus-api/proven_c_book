...
- **현재 판**: v0.46.0 — **초안(draft)**
- **PDF 바로 받기** — [한국어 PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.46.0/proven_c_book-v0.46.0-ko.pdf) · [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.46.0/proven_c_book-v0.46.0-en.pdf)
- **웹으로 읽기** — [한국어](https://rubidus-api.github.io/proven_c_book/ko/) · [English](https://rubidus-api.github.io/proven_c_book/en/)
- **묶음(zip)** — [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.46.0/proven_c_book-v0.46.0-ko.zip) · [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.46.0/proven_c_book-v0.46.0-en.zip) · [전체](https://github.com/rubidus-api/proven_c_book/releases/download/v0.46.0/proven_c_book-v0.46.0-all.zip)
- 저장소 안 사본: [ko PDF](dist/proven_c_book-v0.46.0-ko.pdf) · [en PDF](dist/proven_c_book-v0.46.0-en.pdf)
