...
- **현재 판**: v0.75.3 — **초안(draft)**
- **PDF 바로 받기** — [한국어 PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.75.3/proven_c_book-v0.75.3-ko.pdf) · [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.75.3/proven_c_book-v0.75.3-en.pdf)
- **웹으로 읽기** — [한국어](https://rubidus-api.github.io/proven_c_book/ko/) · [English](https://rubidus-api.github.io/proven_c_book/en/)
- **묶음(zip)** — [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.75.3/proven_c_book-v0.75.3-ko.zip) · [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.75.3/proven_c_book-v0.75.3-en.zip) · [전체](https://github.com/rubidus-api/proven_c_book/releases/download/v0.75.3/proven_c_book-v0.75.3-all.zip)
- 저장소 안 사본: [ko PDF](dist/proven_c_book-v0.75.3-ko.pdf) · [en PDF](dist/proven_c_book-v0.75.3-en.pdf)
...
- 13부 103장 + 부록 A~G + 찾아보기 — 한국어판 917쪽, 영어판 968쪽
