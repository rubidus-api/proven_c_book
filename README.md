...
- **현재 판**: v0.84.0 — **초안(draft)**
- **PDF 바로 받기** — [한국어 PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.84.0/proven_c_book-v0.84.0-ko.pdf) · [English PDF](https://github.com/rubidus-api/proven_c_book/releases/download/v0.84.0/proven_c_book-v0.84.0-en.pdf)
- **웹으로 읽기** — [한국어](https://rubidus-api.github.io/proven_c_book/ko/) · [English](https://rubidus-api.github.io/proven_c_book/en/)
- **묶음(zip)** — [ko](https://github.com/rubidus-api/proven_c_book/releases/download/v0.84.0/proven_c_book-v0.84.0-ko.zip) · [en](https://github.com/rubidus-api/proven_c_book/releases/download/v0.84.0/proven_c_book-v0.84.0-en.zip) · [전체](https://github.com/rubidus-api/proven_c_book/releases/download/v0.84.0/proven_c_book-v0.84.0-all.zip)
- 저장소 안 사본: [ko PDF](dist/proven_c_book-v0.84.0-ko.pdf) · [en PDF](dist/proven_c_book-v0.84.0-en.pdf)
...
- 13부 105장 + 부록 A~I + 찾아보기 — 한국어판 1,023쪽, 영어판 1,082쪽
