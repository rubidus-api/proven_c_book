...
int main(void)
{
    ...
    puts("\n옛 관행과의 차이:");
    puts("  char data[1];  ← '구조체 해킹'. 크기 셈이 1 만큼 어긋나고,");
    puts("                   배열 밖 접근이라 계약 밖이었다.");
    puts("  char data[];   ← C99 가 정식으로 들인 것. 계약 안이다.");
    return 0;
}
